...
set src_parent_id [dotlrn_fs::get_community_root_folder -community_id $source_community]
         ...
         foreach community $selected_community {
            foreach object $object_id { 
                ...
                dotlrn::require_user_admin_community  -community_id $community
                                ...
                                if { [catch {callback datamanager::copy_folder -object_id $object -selected_community $community -mode $mode
                                } errmsg] } {
