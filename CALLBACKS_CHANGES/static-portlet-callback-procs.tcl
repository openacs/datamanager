...
#create the object    
    db_transaction {
        ...
        #ad_return_error "Error:" "#static-portlet.already_exists#<br><br>The error was: $errmsg"
...
ad_proc -public -callback datamanager::export_static -impl datamanager {
  ...
  lappend lista "<pretty_name><!\[CDATA\[$pretty_name\]\]></pretty_name>"
  lappend lista "<body texttype=\"text/html\"><!\[CDATA\[$body\]\]></body>"
